...
### 🧪 Client-Side Isolated Demo Mode & Hardcoded Credentials Pruning (`demoData.js`, `demoState.js`, `demoAdapter.js`, `LoginPage.jsx`, `Header.jsx`, `api.js`, `useStockSSE.js`, `AuthContext.jsx`)
