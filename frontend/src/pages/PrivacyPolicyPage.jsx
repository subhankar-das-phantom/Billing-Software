        ...
        <div className="pp-table-wrap">
          <table>
            <tbody>
              ...
              <tr><td><strong>Email</strong></td><td><a href="mailto:support.bharatenterprises@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors">support.bharatenterprises@gmail.com</a></td></tr>
