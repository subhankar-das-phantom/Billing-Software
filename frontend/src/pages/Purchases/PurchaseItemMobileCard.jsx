      ...
      <div className="p-4 border-b border-slate-700 bg-slate-800/50">
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="text-right shrink-0 space-y-1">
            <span className="inline-flex items-center justify-end gap-1 px-2 py-1 rounded-md text-xs font-medium text-emerald-400">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="input w-full py-2 text-center text-sm text-blue-400"
              min="0"
            />
          </div>
          <div>
