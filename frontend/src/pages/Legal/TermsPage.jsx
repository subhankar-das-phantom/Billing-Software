        ...
        <div className="pp-table-wrap">
          <table>
            <tbody>
              ...
              <tr><td><strong>Email</strong></td><td><a href="mailto:support.bharatenterprise@gmail.com" onClick={(e) => { const isMobile = /Mobi|Android|iPhone|iPad/i.test(navigator.userAgent); if (!isMobile) { e.preventDefault(); navigator.clipboard.writeText('support.bharatenterprise@gmail.com').then(() => { const el = document.getElementById('tc-email-copied'); if(el) { el.style.opacity='1'; setTimeout(()=> el.style.opacity='0', 2000); } }); } }} className="text-blue-400 hover:text-blue-300 transition-colors cursor-pointer" title="Click to copy or email">support.bharatenterprise@gmail.com</a> <span id="tc-email-copied" className="text-emerald-400 text-xs ml-2 transition-opacity duration-300" style={{opacity:0}}>✓ Copied!</span></td></tr>
